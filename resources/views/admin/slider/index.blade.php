        ...
        <div class="card card">
            <div class="card-header cursor-pointer">
                <div class="card-title m-0">
                    <h3 class="fw-bolder fs-6 m-0">Data Slider</h3>
                </div>
                ...
                <table id="example" class="table table-striped table-row-bordered gy-5 gs-7 border rounded"
                    ...
                    <tbody>
                        @foreach ($result as $key => $item)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td><img alt="Logo" src="{{ url('storage/image/slider') }}/{{ $item['gambar'] }}"
                                ...
                                <form action="{{ route('slider.destroy', $item['id']) }}" method="post">
                                    <td class="text-end min-w-50px">
                                        <a class="btn btn-outline btn-outline btn-outline-primary btn-sm btn-active-light-primary font-16 pl-2 addAttr"
                                            ...
                                            data-id="{{ $item['id'] }}" data-satu="{{ $item['gambar'] }}"
                                    ...
                                    <i class="far fa-edit text-primary"></i> Ubah</a> --}}
                                        <button type="submit"
                                            ...
                                            onclick="return confirm('Apakah anda yakin ingin Menghapus data {{ $item['gambar'] }} dari sistem?')">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="mb-0">Tambah Data Slider</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
    ...
    <div class="modal fade" id="kt_modal_new_card" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="mb-0">Detail Data Slider</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                        <!--begin::Svg Icon | path: icons/duotone/Interface/Close-Square.svg-->
                ...
                <div class="modal-body my-1">
                    ...
                    <div class="row">
                        <div class="card-body p-9">
                            <!--begin::Row-->
                            <div class="row mb-7">
                                <label class="col-lg-4 fw-bold text-muted">Nama Gambar</label>
                                <div class="col-lg-8">
