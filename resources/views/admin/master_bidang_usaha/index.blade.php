    ...
    <div class="card card">
        <div class="card-header cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder fs-6 m-0">Data Master Bidang Usaha</h3>
            </div>
            <a data-bs-toggle="modal" data-bs-target="#create_perawat" href="{{route('master_bidang_usaha.create')}}" type="button"
                class="align-self-center  btn btn-sm btn-primary "><i class="fas fa-plus" aria-hidden="true"></i> Tambah
                Master Bidang Usaha</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table id="example" class="table table-striped table-row-bordered gy-5 gs-7 border rounded"
                ...
                <thead>
                    <tr class="fw-bolder fs-6 text-gray-800 px-7">
                        <th>No</th>
                        <th>Nama Master Bidang Usaha</th>
                        <th>Data Dibuat</th>
                        <th>Data Diupdate</th>
                        <th>Aksi</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form action="{{ route('master_bidang_usaha.destroy', $item['id']) }}" method="post">
                        <td style="width: 38%">
                            ...
                            <a class="btn btn-outline btn-outline btn-outline-primary btn-sm btn-active-light-primary font-16 pl-2 addAttr"
                                ...
                                data-id="{{ $item['id'] }}" data-judul="{{ $item['bidang_usaha'] }}"
                            ...
                            <a class="btn btn-outline btn-outline btn-outline-primary btn-sm btn-active-light-primary font-16 pl-2"
                                href="{{ route('master_bidang_usaha.edit', $item['id']) }}">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="mb-0">Tambah Data Data Master Bidang Usaha</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body my-1">
                <div class="container py-5 rounded border p-10 row">
                    <form action="{{route('master_bidang_usaha.store')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12 mb-10">
                                <label class="form-label">Nama Master Bidang Usaha</label>
                                <input type="text" class="form-control" name="bidang_usaha" value="" required="" />
...
<div class="modal fade" id="kt_modal_new_card" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="mb-0">Detail Data Master Bidang Usaha</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                    <!--begin::Svg Icon | path: icons/duotone/Interface/Close-Square.svg-->
            ...
            <div class="modal-body my-1">
                ...
                <div class="row">
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-bold text-muted">Nama Bidang Usaha</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
