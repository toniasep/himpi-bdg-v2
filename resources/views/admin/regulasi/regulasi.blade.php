...
@section('title')
Sunting Halaman Anggota
@endsection
@section('content')
<div class="card card">
    <div class="card-header">
        <h3 class="card-title">Sunting Halaman Anggota</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <form action="{{route('regulasi.update', $result['id'])}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            {{-- START VISI --}}
            <div class="container py-5 rounded border p-10 mb-5 row">
                <div class="row">
                    <div class="col-12 mb-0">
                        <h1 class="text-dark fw-bolder mt-1  fs-2">Sunting Deskripsi Halaman Anggota </h1>
                        <!--begin::Block-->
                        <div class="py-5">
            ...
            <div class="container py-5 rounded border p-10 mb-5 row">
                <div class="row">
                    <div class="col-12 mb-0">
                        <h1 class="text-dark fw-bolder mt-1  fs-2">Sunting Syarat Keanggotaan </h1>
                        <!--begin::Block-->
                        <div class="py-5">
            ...
            <div class="container py-5 rounded border p-10 mb-5 row">
                <div class="row">
                    <div class="col-12 mb-0">
                        <h1 class="text-dark fw-bolder mt-1  fs-2">Sunting Regulasi </h1>
                        <!--begin::Block-->
                        <div class="py-5">
            ...
            <div class="container py-5 rounded border p-10 mb-5 row">
                <div class="row">
                    <div class="col-12 mb-0">
                        <h1 class="text-dark fw-bolder mt-1  fs-2">Sunting Link Pendaftaran Anggota </h1>
                        <!--begin::Block-->
                        <div class="py-5">
                            <input type="text" name="k4" class="form-control" value="{{$result['k4']}}">
                        </div>
                        <!--end::Block-->
                        @if ($errors->has('k4'))
                        <span class="help-block text-danger">
                            <strong>{{ $errors->first('k4') }}</strong>
                        </span>
                        @endif
                    </div>
                </div>
